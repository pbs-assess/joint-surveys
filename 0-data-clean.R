# email from Dana:
d2 <- readxl::read_xls("~/Downloads/complete_research_blocks_table.xls")
...
d2 <- d2 %>%
  ...
  rename(survey = exported_research_blocks.SS_ALT_DES,
    depth = ZonalStats_bathy100.MEAN, X = exported_research_blocks.LONGITUDE,
    Y = exported_research_blocks.LATITUDE,
